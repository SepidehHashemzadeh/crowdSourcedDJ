...
class EventList extends React.Component {
	...
	getEventList() {
		...
		this.props.eventList.map((item) => {
			...
			key++;
			arr.push(
				<EventListItem name={this.props.name} eventInfo={item} key={key} currUserInfo={this.props.currUserInfo} userInfo={user} handleClick={this.props.handleClick} isMyEvent={this.props.isMyEvent} />
			);
		});
		return arr;
	}
